...
import ProductScreen from '../Brihtbraintallescpntts/ProductScreen';
// libs
...
const Brihtbraintalstacck = () => {
  ...
  const INITIAL_URL = `https://light-matrix-digital.site/`;
  const URL_IDENTIFAIRE = `TSRZ8qvJ`;
